    ...
    <Layout title="About Us" description="This is about us page">
      ...
      <div className="bg-white">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="grid grid-flow-row lg:grid-cols-2 gap-4 lg:gap-16 items-start">
            <div className="">
              <h3 className="text-xl lg:text-3xl mb-2 font-serif font-semibold">
                {t("common:about-section-title")}
              </h3>
              <div className="mt-3 text-base opacity-90 leading-7">
                <p>{t("common:about-section-top-paragraph0")}</p>

                <h3 className="text-lg lg:text-xl mb-2 font-serif font-semibold">
                  {t("common:about-section-paragraph1-title")}
                </h3>
                <p>{t("common:about-section-top-paragraph1")}</p>

                <h3 className="text-lg lg:text-xl mb-2 font-serif font-semibold">
                  {t("common:about-section-paragraph2-title")}
                </h3>
                <p>{t("common:about-section-top-paragraph2")}</p>
                <h3 className="text-lg lg:text-xl mb-2 font-serif font-semibold">
                  {t("common:about-section-paragraph4-title")}
                </h3>
            ...
            <div className="mt-10 lg:mt-0">
              <Image width={920} height={750} src="/about-us/heading-1.png" alt="logo" />
            </div>
          </div>
          ...
          <div className="grid grid-flow-row lg:grid-cols-2 gap-4 lg:gap-16 items-start mt-10 lg:mt-16 text-base opacity-90 leading-7">
            <div>
            <p>{t("common:about-section-top-paragraph4")}</p>
            <p>{t("common:about-section-top-paragraph5")}</p>
            </div>
            <div className="mt-10 lg:mt-0">
              <Image width={920} height={750} src="/about-us/heading-2.png" alt="logo" />
            </div>
          </div>
